...
export default {
  ...
  methods: {
    renderNewProduct() {
      if (
        Object.prototype.toString.call(this.typeOfhotproduct) ===
        "[object String]"
      ) {
        this.storeList = eval(this.typeOfhotproduct)[13].data;
        ...
        this.typeOfhotproduct.then(typeOfhotproduct => {
          this.storeList = JSON.parse(typeOfhotproduct)[13].data;
          this.title = this.storeList.group_section.title;
          this.desc = this.storeList.group_section.desc;
          this.enjoy_url_text = this.storeList.group_section.enjoy_url_text;
          this.tabs = this.storeList.tabs;
