...
export default {
  ...
  methods: {
    renderNewVipContent() {
      if (
        Object.prototype.toString.call(this.typeOfnewvip) === "[object String]"
      ) {
        this.newvipContent = eval(this.typeOfnewvip)[1];
        this.littleContent = eval(this.typeOfnewvip)[2];
        this.newslists = eval(this.typeOfnewvip)[3].data;
        this.productMsg = eval(this.typeOfnewvip)[4].data.tabs;
        ...
        this.typeOfnewvip.then(typeOfnewvip => {
          this.newvipContent = JSON.parse(typeOfnewvip)[1];
          this.littleContent = JSON.parse(typeOfnewvip)[2];
          this.newslists = JSON.parse(typeOfnewvip)[3].data;
          this.productMsg = JSON.parse(typeOfnewvip)[4].data.tabs;
          this.title = this.newvipContent.data.group_section.title;
          this.imgArr = this.newvipContent.data.tabs;
          this.littleTittle = this.littleContent.data.group_section.title;
          this.classifyArr = this.littleContent.data.tabs;
